...
int ezThreeFourths(int x) {
   /*
   (1) multiply by 3, which we can simplify to 2x + x or (x * 2^1) + x
   ...
   then we & 3 so that, only if (x >> 31) is negative, it keeps the 11 at the end of 3. otherwise, the bias becomes all zeros.
   
   (3) divide by 4 (or x / 2^2) and floor.
   */
   int bias;
